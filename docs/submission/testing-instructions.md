...
> The hosted demo is **live at https://superayin.com** (Alibaba Cloud ECS, real Let's Encrypt cert) — free to access for judges through **July 31, 2026**.

---

## Option A — hosted demo (recommended)

1. Go to **https://superayin.com** and click **Log in**.
