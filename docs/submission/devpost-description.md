...
Paste-ready copy for the Devpost form. Fill the two placeholders (`<LIVE_URL>`, `<VIDEO_URL>`) once the ECS deploy and the video are done.
...
See `docs/submission/testing-instructions.md`. Live demo: `<LIVE_URL>`, demo credentials provided there; free to access for judges through July 31.
